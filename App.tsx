          ...
          <>
            ...
            <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 px-6 py-3 z-30 pb-safe">
              <div className="flex justify-between items-center max-w-lg mx-auto">
                <button onClick={() => setView('dashboard')} className="flex flex-col items-center gap-1 text-primary w-12 transition-colors">
                ...
                <button onClick={() => setView('advertising')} className="flex flex-col items-center gap-1 text-slate-400 hover:text-blue-500 w-12 transition-colors">
                  <span className="material-symbols-outlined text-[24px] text-blue-500">campaign</span>
                  <span className="text-[10px] font-medium text-blue-500">Quảng Cáo</span>
                </button>
              </div>
            </nav>
          </>
